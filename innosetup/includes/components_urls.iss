...
; Laboratory channel
#define LAB_FILE_URL_COMMON64 "http://wohlsoft.ru/builds/win32/moondust-win64/install-pge-common-master-win64.zip"
#define LAB_FILE_URL_COMMON32 "http://wohlsoft.ru/builds/win32/moondust-win32/install-pge-common-master-win32.zip"

#define LAB_FILE_URL_EDITOR64 "http://wohlsoft.ru/builds/win32/moondust-win64/install-pge-editor-master-win64.zip"
#define LAB_FILE_URL_EDITOR32 "http://wohlsoft.ru/builds/win32/moondust-win32/install-pge-editor-master-win32.zip"

#define LAB_FILE_URL_ENGINE64 "http://wohlsoft.ru/builds/win32/moondust-win64/install-pge-engine-master-win64.zip"
#define LAB_FILE_URL_ENGINE32 "http://wohlsoft.ru/builds/win32/moondust-win32/install-pge-engine-master-win32.zip"

#define LAB_FILE_URL_TOOLS64  "http://wohlsoft.ru/builds/win32/moondust-win64/install-pge-tools-master-win64.zip"
#define LAB_FILE_URL_TOOLS32  "http://wohlsoft.ru/builds/win32/moondust-win32/install-pge-tools-master-win32.zip"
